...
Interacto is both implemented in TypeScript and Java (JavaFX). The TypeScript implementation is the current focus of development and will be the main focus of this documentation, but both implementations are fairly similar.
